...
{
  internal class SiteMapConfig : GenericConfig
  {
    public SiteMapConfig()
      : base()
    {
      typeName = "MySqlSiteMapProvider";
      sectionName = "siteMap";
    }
    ...
    protected override ProviderSettings GetMachineSettings()
    {
      ...
      SiteMapSection section = (SiteMapSection)machineConfig.SectionGroups["system.web"].Sections[sectionName];
